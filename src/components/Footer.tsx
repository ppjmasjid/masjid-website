        ...
        <footer className=" text-white">
            ...
            <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-gray-400">
                        ...
                        <li><a href="#" className="hover:text-blue-500 transition">Social Welfare</a></li>
                    </ul>
                </div>
            ...
            <div className="bg-gray-800 text-gray-400 py-4 px-4 md:px-8 text-sm">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <p>© {new Date().getFullYear()} GCMIS. All Rights Reserved.</p>
                    <p>Design & developed by M360ICT</p>
                </div>
            </div>
